...
if item_enchantment_aura_reduce_armor == nil then
    item_enchantment_aura_reduce_armor = class({})
end

item = item_enchantment_aura_reduce_armor


function GetSkillName()
    return "enchantment_aura_reduce_armor"
end
