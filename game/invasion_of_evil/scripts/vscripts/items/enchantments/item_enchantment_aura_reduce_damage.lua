...
if item_enchantment_aura_reduce_damage == nil then
    item_enchantment_aura_reduce_damage = class({})
end

item = item_enchantment_aura_reduce_damage


function GetSkillName()
    return "enchantment_aura_reduce_damage"
end
